package main.src.java.cardoso.AESinECB.useful;
...
public class BinUtils {
    ...
    public static String repeatingKeyXOR (String hex_str, String one_byte_hex_str){
    ...
    public static byte[] binToManyBytes(String binaryString) {
        int splitSize = 8;
